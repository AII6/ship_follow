...
class DecodeBox():
    ...
    def decode_box(self, inputs):
        ...
        for i, input in enumerate(inputs):
            ...
            #   batch_size,3,20,20
            #----------------------------------------------------------#
            anchor_w = FloatTensor(scaled_anchors).index_select(1, LongTensor([0])) # 所有第二维的第一个元素
            anchor_h = FloatTensor(scaled_anchors).index_select(1, LongTensor([1])) # 所有第二维的第二个元素
